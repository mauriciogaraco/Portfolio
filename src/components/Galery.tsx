...
import PhotoIcon from "./icons/PhotoIcon.astro";
...
export function Galery() {
  ...
  return (
    <>
      <div
        className="   light:bg-white border 
  light:border-gray-200 rounded-lg shadow bg-gray-800 border-gray-700 "
      >
        <button className="p-1.5" onClick={toggleModal}>
          {/*   <svg
